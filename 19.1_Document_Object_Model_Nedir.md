...
# DOM (Document Object Model), HTML ve XML belgelerinin bir modelidir ve bu belgeye
# JavaScript gibi dillerle erişimi sağlayan bir arayüzdür. DOM, bir sayfadaki her öğeyi
# (etiketler, metinler, attributeler vb.) nesneler olarak temsil eder ve bu nesneler
# üzerinde işlem yapmamıza olanak tanır.
...
# DOM, HTML belgesinin yapısını bir ağaç yapısı gibi temsil eder. Aşağıda basit bir HTML
# yapısının DOM üzerindeki temsilini inceleyelim:
...
# Bu açıklama, HTML belgelerinin nasıl bir ağaç yapısında DOM tarafından temsil edildiğini
# ve her bir öğenin (etiketin) nasıl bir düğüm olarak işlendiğini anlatmaktadır.
